...
export default function SetRankError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Set ranking error:", error)
  }, [error])
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold mb-3">Rankings Unavailable</h1>
        <p className="text-gray-700 dark:text-gray-300 mb-2">
          We couldn&apos;t load the set rankings. This might be due to:
        </p>
