...
// Server-side version of getSetValueRows
export async function getSetValueRowsServer(
...
// Server-side version of getSetValueThemes
export async function getSetValueThemesServer(): Promise<string[]> {
  const supabase = createServerSupabaseClient()
  const pageSize = 1000
  let from = 0
